...
class BotDetector:
    def __init__(self):
        ...
        self.browserdata={"global":{"innerHeight":540,"innerWidth":1920,"outerHeight":1040,"outerWidth":1920,"screenX":0,"screenY":0,"isSecureContext":True,"devicePixelRatio":1},"screen":{"height":1080,"width":1920,"availHeight":1040,"availWidth":1920,"pixelDepth":24,"colorDepth":24},"navigator":{"appCodeName":"Mozilla","appName":"Netscape","appVersion":"5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36","buildID":None,"cpuClass":None,"hardwareConcurrency":12,"maxTouchPoints":0,"platform":"Win32","product":"Gecko","productSub":"20030107","oscpu":None,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36","vendor":"Google Inc.","vendorSub":"","doNotTrack":None,"webdriver":False},"operaVersion":None,"toolbar":True,"locationbar":True}
    ...
    def generatedata(self):
        ...
        signals.append(["custom_ChromeConsole",True])
